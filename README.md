...
- [ ] Add an email address to the `ADMINS` settings variable in `pivo/pivo/settings/base.py`
- [ ] Change the `SERVER_EMAIL` to the email address used to send e-mails in `pivo/pivo/settings/production.py`
...
- Create a copy of ``pivo/settings/local.py.example``:  
  `cp pivo/settings/local.py.example pivo/settings/local.py` (remembering you should replace `pivo` with your project's name!).
